        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" action="update1_config.php">
                        <h2 class="form-title">Update Scientist</h2>
                        <div class="form-group">
                            <input type="password" class="form-input" name="drugid" id="drugid" placeholder="Scientist Id"/>
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <input type="text" class="form-input" name="price" id="price" placeholder="Lab"/>
                        </div>
